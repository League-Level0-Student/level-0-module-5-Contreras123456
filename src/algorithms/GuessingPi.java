...
String xbox = "3.1415926535";
		// 3. Print out the first 3 digits of Pi to the console.
		//    The first value is "pi.charAt(0)", the second is "pi.charAt(1)", etc.
		//    Run your program to see how this works.
System.out.println(xbox.charAt(0));
System.out.println(xbox.charAt(1));
System.out.println(xbox.charAt(2));
System.out.println(xbox.charAt(3));
